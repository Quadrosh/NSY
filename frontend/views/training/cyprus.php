    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
                ...
                <p class="mt50"><?= nl2br($training->text1) ?></p>
                <h2 class="mt50 mb50">Если Вы:</h2>
                <ul>
<?php foreach ($ifyous as $ifyou) : ?>
                    <li><p><span><i class="glyphicon glyphicon-exclamation-sign"></i></span><?= $ifyou->text ?></p></li>
<?php endforeach; ?>

                </ul>
                <p class="mb50"><?= nl2br($training->text2) ?></p>
            </div>
        </div>
    </div>
</section>
...
<section class="why_we white">
    <div class="container">
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
                <h2 class="mt50 mb50">Вас ожидают:</h2>
                <ul>
                    <?php foreach ($methods as $method) : ?>
                        <li><p><span><i class="glyphicon glyphicon-ok-sign"></i></span><?= $method->text ?></p></li>
                    <?php endforeach; ?>
                </ul>
                <p class="mb50"><?= nl2br($training->text3) ?></p>

                <div class="text-center mt30 mb50">
                    <p>
                        <?=  Html::a('Отправить заявку на участие', [
                            'send/training',
                            'to'=>$master['hrurl'],
                            'training'=>$training->date
                        ], ['class' => 'btn btn_custom_nofloat']); ?>
                    </p>
...
<?php if (!empty($training->action_2_name)) : // Action 2 line ?>
    <section class="action_line">
        <div class="action_wrapper">
            <div class="text">
                <h1><?= $training->action_2_name ?></h1>
            </div>
    <?php if (!empty($training->action_2_link)) : // Action 2 line ?>
            <div class="al_btn">
                <?php echo  Html::a( $training->action_2_go , [
