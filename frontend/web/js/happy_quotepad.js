...
window.onload = function() {
    ...
    if (document.getElementById('slideshow')) {
        ...
        for (var iter = 0; iter < length; iter += 1) {
            looptl.to(".anishow", duration * 0.3,  {autoAlpha: 0, ease:Power1.easeInOut})
                ...
                .to(items[iter], duration * 1.5, { x: -20, autoAlpha: 0, ease: Power2.easeInOut })
    ...
    if (document.getElementById('cars')) {
        ...
        var q3ReachCarTl = new TimelineMax({paused: true})
            ...
            .fromTo("#moneyclowd", durationCars* 5, {autoAlpha:0, scale:0.3 }, {autoAlpha:1, scale:1.0 , ease: Power3.easeInOut}, "richcarmainstep")
            .fromTo("#girlscloud", durationCars*3.5, {autoAlpha:0, scale:0.3 }, {autoAlpha:1, scale:1.0 , ease: Power3.easeInOut}, durationCars*5)
            .fromTo("#lamborginicloud", durationCars*2, {autoAlpha:0, scale:0.3 }, {autoAlpha:1, scale:1.0 , ease: Power3.easeInOut}, durationCars*7)

            .fromTo("#richsmoke2", durationCars * 4, {autoAlpha:1, scale:1.0}, {autoAlpha:0, scale:1.5, ease: Linear.easeNone}, "richcarmainstep")
            .fromTo("#richsmoke1", durationCars * 4, {autoAlpha:1, scale:1.0, x: 10}, {autoAlpha:0.5, scale:1.3, x: 0,  ease: Linear.easeNone}, "richcarmainstep")
            .fromTo("#richwheelback", durationCars * 0.5, {scaleY:1.0}, {scaleY:1.1, ease: Linear.easeNone}, "richcarmainstep")
            ...
            .to("#richwheelback", durationCars * 0.5, {scaleX:1.0, ease:Linear.easeNone}, durationCars*7)

            .fromTo("#richwheelfront", durationCars * 0.5, {scaleY:1.0}, {scaleY:0.9, ease: Linear.easeNone}, "richcarmainstep")
            ...
            .to("#richwheelfront", durationCars * 0.5, {scaleY:1.1, ease:Linear.easeNone}, durationCars*4)
            ...
            .to("#richwheelfront", durationCars * 0.5, {scaleX:1.0, ease:Linear.easeNone}, durationCars*6.5)
            .to("#richwheelfront", durationCars * 0.5, {scaleX:1.1, ease:Linear.easeNone}, durationCars*7)
            ;

        var q3ReachCarTlWheels = new TimelineMax({paused: true, repeat: 1})
            .fromTo("#richsmoke2", durationCars * 4, {autoAlpha:1, scale:1.0}, {autoAlpha:0, scale:1.5, ease: Linear.easeNone}, "richcarmainstep")
            .fromTo("#richsmoke1", durationCars * 4, {autoAlpha:1, scale:1.0, x: 10}, {autoAlpha:0.5, scale:1.3, x: 0,  ease: Linear.easeNone}, "richcarmainstep")
            .fromTo("#richwheelback", durationCars * 0.5, {scaleY:1.0}, {scaleY:1.1, ease: Linear.easeNone}, "richcarmainstep")
            .to("#richwheelback", durationCars * 0.5, {scaleY:1.0, ease:Linear.easeNone}, durationCars*0.5)
        ...
        var q3ReachCarTlEnd = new TimelineMax({paused: true})
            .to("#moneyclowd", durationCars * 0.5, {autoAlpha:0, ease:Linear.easeNone}, "richout")
            .to("#richcar", durationCars * 2, {autoAlpha:0, ease:Linear.easeNone}, "richout")
            .to("#girlscloud", durationCars * 0.5, {autoAlpha:0, ease:Linear.easeNone}, "richout")
            .to("#lamborginicloud", durationCars * 0.5, {autoAlpha:0, ease:Linear.easeNone}, "richout")
            ;
        ...
        var q3HappyCarTl = new TimelineMax({paused: true})
            ...
            //.to("#smilecloud", durationCars * 1, {scale:1.0, ease:Linear.easeNone}, durationCars*2)
            ...
            .to("#happywheelfront", durationCars * 0.5, {scaleX:1.0, ease:Linear.easeNone}, durationCars*3)
            .to("#happywheelfront", durationCars * 0.5, {scaleX:1.1, ease:Linear.easeNone}, durationCars*3.5)
            ...
            .to("#happyotherwheel1", durationCars * 0.5, {scaleY:1.0, ease:Linear.easeNone}, durationCars*3)
            .to("#happyotherwheel1", durationCars * 0.5, {scaleY:1.1, ease:Linear.easeNone}, durationCars*3.5)
            ;

        var q3HappyCarTlwheel = new TimelineMax({paused: true, repeat: 4})
            .fromTo("#happyclowd1", durationCars * 0.8, {autoAlpha:1, scale:1.0, x: 20}, {autoAlpha:0, scale:1.5, x: "-=10", ease: Linear.easeNone}, "happycarmainstep")
            .fromTo("#happyclowd2_1_", durationCars * 1.2, {autoAlpha:1, scale:1.0, x: 20}, {autoAlpha:0, scale:1.3, x: 0,  ease: Linear.easeNone}, "happycarmainstep")
            .fromTo("#happyclowd1", durationCars, {autoAlpha:1, scale:0.05, x: 85}, {autoAlpha:0, scale:1.5, x: "-=85", ease: Linear.easeNone}, durationCars*0.8)
            .fromTo("#happyclowd2_1_", durationCars, {autoAlpha:1, scale:0.05, x: 35}, {autoAlpha:0, scale:1.3, x: 0,  ease: Linear.easeNone}, durationCars*1.2)
        ...
        var q3StartTl = new TimelineMax()
            .fromTo("#textbox", durationCars * 5, {x: "54%"}, {x: "0%", ease:Power1.easeOut})

        ;

        var q3MasterTl = new TimelineMax({ repeat: -1})

            .add(q3ReachCarTl.play())
            .add(q3ReachCarTlWheels.play())
            .add(q3ReachCarTlEnd.play())
            .add(q3HappyCarTl.play())
            .add(q3HappyCarTlwheel.play())
            ;
